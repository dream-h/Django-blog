# Generated by Django 2.1 on 2019-06-04 07:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type_id', models.IntegerField(choices=[(1, 'Python'), (2, 'Django'), (3, 'book'), (4, '区块链'), (5, '人工智能')], default=None)),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.CharField(max_length=64, unique=True, verbose_name='个人博客前缀')),
                ('theme', models.CharField(max_length=32, unique=True, verbose_name='个人博客主题')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='back', to='repository.Comment', verbose_name='回复评论')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Article', verbose_name='所赞文章')),
            ],
        ),
        migrations.CreateModel(
            name='UserFans',
        ...
        migrations.AddField(
            model_name='blog',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='repository.UserInfo', verbose_name='关联用户'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.Category', verbose_name='所属分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(through='repository.Article2Tag', to='repository.Tag', verbose_name='文章标签'),
        ),
